import { ClientClerkSignIn } from '@/components/auth/ClientClerkSignIn';
  ...
  return (
    <div className="flex min-h-[60dvh] flex-col items-center justify-center px-4 py-10">
      <div className="mb-8 flex flex-col items-center gap-3">
        ...
        <p className="text-sm text-[#8C7B6B]">Sign in to your account</p>
      </div>

      <ClientClerkSignIn appearance={signInAppearance} />
    </div>
  );
}
